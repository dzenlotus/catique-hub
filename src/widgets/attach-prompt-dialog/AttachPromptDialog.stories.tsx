...
function stubBoard(id: string, name: string, spaceId = "spc-1"): Board {
  return { id, name, spaceId, roleId: null, position: 1, description: null, color: null, icon: null, isDefault: false, ownerRoleId: "maintainer-system", createdAt: 0n, updatedAt: 0n };
}
...
function stubPrompt(id: string, name: string): Prompt {
  return { id, name, content: "", color: null, shortDescription: null, icon: null, examples: [], tokenCount: null, createdAt: 0n, updatedAt: 0n };
}
